...
as its code of conduct. Please read it for the full description of expected
behavior and unacceptable behavior. In short: be respectful, assume good faith,
give and accept constructive feedback gracefully, and focus on what is best for
the community.

## Scope

This Code of Conduct applies within all project spaces — the repository, issues,
pull requests, discussions — and applies when an individual is officially
