...
using Dignite.Extract.Documents.Pipelines.Classification;
...
public class KeyedChatClientRegistration_Tests
{
    ...
    {
        typeof(ExtractConsts).Assembly,                    // Dignite.Extract.Abstractions
        typeof(IDocumentRepository).Assembly,                  // Dignite.Extract.Domain
        typeof(DocumentDto).Assembly,                          // Dignite.Extract.Application.Contracts
        typeof(DocumentClassificationWorkflow).Assembly,       // Dignite.Extract.Application (where keyed consumers live)
    };
