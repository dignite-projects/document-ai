...
/// </summary>
public class DocumentReprocessing_Tests : PaperbaseEntityFrameworkCoreTestBase
{
    ...
    public async Task FieldExtraction_Run_Is_Lifecycle_Neutral_On_Ready_Document()
    {
        ...
        await WithUnitOfWorkAsync(async () =>
        {
            ...
            var te = await _pipelineRunManager.StartAsync(doc, PaperbasePipelines.TextExtraction);
            await _pipelineRunManager.CompleteAsync(doc, te);
            var cls = await _pipelineRunManager.StartAsync(doc, PaperbasePipelines.Classification);
        ...
        await WithUnitOfWorkAsync(async () =>
        {
            ...
            var fe = await _pipelineRunManager.StartAsync(doc, PaperbasePipelines.FieldExtraction);
