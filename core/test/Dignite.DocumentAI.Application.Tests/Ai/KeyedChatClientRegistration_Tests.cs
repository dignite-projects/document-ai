...
/// <c>DocumentAIHostModule.ConfigureAI</c> adds or removes a <c>AddKeyedChatClient(...)</c> call,
...
{
    /// <summary>
    /// Snapshot of <c>DocumentAIHostModule.ConfigureAI</c>'s <c>AddKeyedChatClient(...)</c>
    ...
    {
        typeof(DocumentAIConsts).Assembly,                    // Dignite.DocumentAI.Abstractions
        typeof(IDocumentRepository).Assembly,                  // Dignite.DocumentAI.Domain
        typeof(DocumentDto).Assembly,                          // Dignite.DocumentAI.Application.Contracts
        typeof(DocumentClassificationWorkflow).Assembly,       // Dignite.DocumentAI.Application (where keyed consumers live)
    };
    ...
    public void Every_Consumed_Key_Is_Registered_By_The_Host()
    {
        ...
        orphans.ShouldBeEmpty(
            ...
            "DocumentAIHostModule.ConfigureAI. Either add the AddKeyedChatClient call there, " +
