...
/// (<see cref="VaultExtractHttpApiModule"/>) on top of the reused EF Core test module (in-memory SQLite +
...
[DependsOn(
    ...
    typeof(VaultExtractEntityFrameworkCoreTestModule)
)]
public class VaultExtractHttpApiTestModule : AbpModule
{
