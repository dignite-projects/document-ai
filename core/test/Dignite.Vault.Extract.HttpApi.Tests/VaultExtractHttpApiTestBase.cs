...
/// <see cref="VaultExtractHttpApiTestModule"/> and exposes a <c>Client</c>
...
public abstract class VaultExtractHttpApiTestBase : AbpAspNetCoreIntegratedTestBase<VaultExtractHttpApiTestModule>
