...
namespace Dignite.DocumentAI.HttpApi.Documents.Cabinets;

[Area("document-ai")]
[Route("api/document-ai/cabinets")]
public class CabinetController : DocumentAIController, ICabinetAppService
{
