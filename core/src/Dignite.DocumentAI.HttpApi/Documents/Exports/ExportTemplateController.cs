...
namespace Dignite.DocumentAI.HttpApi.Documents.Exports;

[Area("document-ai")]
[Route("api/document-ai/export-templates")]
public class ExportTemplateController : DocumentAIController, IExportTemplateAppService
{
