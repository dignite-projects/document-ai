...
namespace Dignite.DocumentAI.HttpApi.Documents.DocumentTypes;

[Area("document-ai")]
[Route("api/document-ai/document-types")]
public class DocumentTypeController : DocumentAIController, IDocumentTypeAppService
{
