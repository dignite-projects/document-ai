...
public class FieldDefinition : FullAuditedAggregateRoot<Guid>, IMultiTenant
{
    ...
    private static string ValidateName(string name)
    {
        ...
        {
            throw new BusinessException(DocumentAIErrorCodes.FieldDefinition.InvalidName)
                .WithData("name", name)
    ...
    private static string ValidateDisplayName(string displayName)
    {
        ...
        {
            throw new BusinessException(DocumentAIErrorCodes.FieldDefinition.InvalidDisplayName)
    ...
    private static bool ValidateMultiValue(bool allowMultiple, FieldDataType dataType)
    {
        ...
        {
            throw new BusinessException(DocumentAIErrorCodes.FieldDefinition.MultiValueRequiresStringType)
