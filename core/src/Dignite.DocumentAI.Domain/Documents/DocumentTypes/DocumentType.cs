...
public class DocumentType : FullAuditedAggregateRoot<Guid>, IMultiTenant
{
    ...
    private static string ValidateTypeCode(string typeCode)
    {
        ...
        {
            throw new BusinessException(DocumentAIErrorCodes.DocumentType.InvalidCodeFormat)
    ...
    private static string? ValidateDescription(string? description)
    {
        ...
        {
            throw new BusinessException(DocumentAIErrorCodes.DocumentType.InvalidDescription)
