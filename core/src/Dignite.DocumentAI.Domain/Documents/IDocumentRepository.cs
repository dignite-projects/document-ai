...
public interface IDocumentRepository : IRepository<Document, Guid>
{
    ...
    /// Passing ranges for Text/Boolean throws <see cref="DocumentAIErrorCodes.ExtractedField.FieldTypeDoesNotSupportRange"/>;
    /// values that cannot parse as the declared type throw <see cref="DocumentAIErrorCodes.ExtractedField.InvalidValue"/>.
