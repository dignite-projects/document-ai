...
///
/// <para>
/// 这是 DocumentAI 中**首个同步 request/response 形态的 LLM 调用点**（其余 LLM 调用都在
...
public class SlugSuggestionAppService : DocumentAIAppService, ISlugSuggestionAppService
{
    ...
    private static ChatResponseFormat CreateSlugResponseFormat()
    {
        ...
        return ChatResponseFormat.ForJsonSchema(
            ...
            schemaName: "DocumentAISlugSuggestion",
            schemaDescription: "A single suggested DocumentAI machine identifier.");
    }
}
