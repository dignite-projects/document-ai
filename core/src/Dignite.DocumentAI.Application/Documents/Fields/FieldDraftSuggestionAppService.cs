...
/// </summary>
[Authorize]
public class FieldDraftSuggestionAppService : DocumentAIAppService, IFieldDraftSuggestionAppService
{
    ...
    {
        if (!await AuthorizationService.IsGrantedAsync(DocumentAIPermissions.FieldDefinitions.Create)
            && !await AuthorizationService.IsGrantedAsync(DocumentAIPermissions.FieldDefinitions.Update))
        {
    ...
    private static ChatResponseFormat CreateDraftResponseFormat()
    {
        ...
        return ChatResponseFormat.ForJsonSchema(
            ...
            schemaName: "DocumentAIFieldDraft",
