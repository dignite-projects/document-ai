...
using Dignite.DocumentAI.Documents.Pipelines.FieldExtraction;
...
public class DocumentPipelineJobScheduler : ITransientDependency
{
        ...
        TimeSpan? delay = null)
    {
        ...
        {
            DocumentAIPipelines.TextExtraction => _backgroundJobManager.EnqueueAsync(
            ...
            DocumentAIPipelines.Classification => _backgroundJobManager.EnqueueAsync(
                ...
                delay: effectiveDelay),
            DocumentAIPipelines.FieldExtraction => _backgroundJobManager.EnqueueAsync(
                ...
                delay: effectiveDelay),
            _ => throw new BusinessException(DocumentAIErrorCodes.Pipeline.UnknownCode)
