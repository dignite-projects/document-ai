...
using Dignite.DocumentAI.Documents.Pipelines.Reprocessing;
...
public class DocumentReprocessingAppService : DocumentAIAppService, IDocumentReprocessingAppService
{
    ...
    [Authorize(DocumentAIPermissions.Documents.Reprocessing.FieldExtraction)]
    ...
    [Authorize(DocumentAIPermissions.Documents.Reprocessing.Reclassification)]
