...
/// <summary>
/// DI keys for the keyed <c>IChatClient</c> instances DocumentAI's core LLM call sites resolve.
/// Registered by the host wiring (<c>DocumentAIHostModule.ConfigureAI</c>) and consumed by the
...
/// </summary>
public static class DocumentAIConsts
{
    /// <summary>
