...
public class DocumentReprocessingController : VaultExtractController, IDocumentReprocessingAppService
{
    ...
    // GET /api/vault-extract/document-reprocessing/field-extraction/preview?documentTypeId=...
    ...
    // POST /api/vault-extract/document-reprocessing/field-extraction
    ...
    // POST /api/vault-extract/document-reprocessing/reclassification/preview
    ...
    // POST /api/vault-extract/document-reprocessing/reclassification
