...
/// section by <see cref="DocumentAIVisionLlmOcrModule"/>. The vision model id / endpoint / key are NOT
/// here — those are host deployment concerns wired in <c>DocumentAIHostModule.ConfigureAI</c> as a keyed
