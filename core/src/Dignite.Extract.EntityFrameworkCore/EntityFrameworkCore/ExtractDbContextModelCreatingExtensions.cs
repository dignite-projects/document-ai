...
public static class ExtractDbContextModelCreatingExtensions
{
    ...
    public static void ConfigureExtract(this ModelBuilder builder)
    {
        Check.NotNull(builder, nameof(builder));

        builder.Entity<Document>(b =>
        {
            b.ToTable(ExtractDbProperties.DbTablePrefix + "Documents", ExtractDbProperties.DbSchema);
        ...
        {
            b.ToTable(ExtractDbProperties.DbTablePrefix + "DocumentExtractedFields", ExtractDbProperties.DbSchema);
            b.ConfigureByConvention();
        ...
        {
            b.ToTable(ExtractDbProperties.DbTablePrefix + "DocumentPipelineRuns", ExtractDbProperties.DbSchema);
            b.ConfigureByConvention();
        ...
        {
            b.ToTable(ExtractDbProperties.DbTablePrefix + "DocumentSegments", ExtractDbProperties.DbSchema);
            b.ConfigureByConvention();
        ...
        {
            b.ToTable(ExtractDbProperties.DbTablePrefix + "DocumentTypes", ExtractDbProperties.DbSchema);
            b.ConfigureByConvention();
        ...
        {
            b.ToTable(ExtractDbProperties.DbTablePrefix + "FieldDefinitions", ExtractDbProperties.DbSchema);
            b.ConfigureByConvention();
        ...
        {
            b.ToTable(ExtractDbProperties.DbTablePrefix + "ExportTemplates", ExtractDbProperties.DbSchema);
            b.ConfigureByConvention();
        ...
        {
            b.ToTable(ExtractDbProperties.DbTablePrefix + "Cabinets", ExtractDbProperties.DbSchema);
            b.ConfigureByConvention();
