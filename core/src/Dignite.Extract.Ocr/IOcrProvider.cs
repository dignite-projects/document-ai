...
/// <c>Dignite.Extract.Ocr</c> to obtain <see cref="IOcrProvider"/> + <see cref="OcrOptions"/> +
/// <see cref="OcrResult"/>. They do not need to reference <c>Dignite.Extract.Parse</c>
/// (the orchestrator) or <c>Dignite.Extract.Abstractions</c> (the top-level ITextExtractor
/// contract).
/// </summary>
/// <remarks>
/// <para>
