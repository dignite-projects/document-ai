...
public class DocumentAIHostDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public DocumentAIHostDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
