...
public class VaultExtractHostDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public VaultExtractHostDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
