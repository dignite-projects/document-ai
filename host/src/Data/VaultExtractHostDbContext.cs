...
public class VaultExtractHostDbContext
    : AbpDbContext<VaultExtractHostDbContext>, IHasEventInbox, IHasEventOutbox
{
    ...
    public VaultExtractHostDbContext(DbContextOptions<VaultExtractHostDbContext> options)
        : base(options)
    {
    }
