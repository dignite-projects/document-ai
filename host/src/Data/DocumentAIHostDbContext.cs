...
public class DocumentAIHostDbContext
    : AbpDbContext<DocumentAIHostDbContext>, IHasEventInbox, IHasEventOutbox
{
    ...
    public DocumentAIHostDbContext(DbContextOptions<DocumentAIHostDbContext> options)
        : base(options)
    {
    }
