...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Dignite.Extract.Documents.Cabinets.Cabinet", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Dignite.Extract.Documents.Document", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Dignite.Extract.Documents.DocumentExtractedField", b =>
                {
            ...
            modelBuilder.Entity("Dignite.Extract.Documents.DocumentTypes.DocumentType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Dignite.Extract.Documents.Exports.ExportTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Dignite.Extract.Documents.Fields.FieldDefinition", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Dignite.Extract.Documents.Pipelines.DocumentPipelineRun", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Dignite.Extract.Documents.Segments.DocumentSegment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Dignite.Extract.Documents.Document", b =>
                {
                    b.HasOne("Dignite.Extract.Documents.Cabinets.Cabinet", null)
                        .WithMany()
                        .HasForeignKey("CabinetId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("Dignite.Extract.Documents.DocumentTypes.DocumentType", null)
                        .WithMany()
                        .HasForeignKey("DocumentTypeId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.OwnsOne("Dignite.Extract.Documents.FileOrigin", "FileOrigin", b1 =>
                        {
            ...
            modelBuilder.Entity("Dignite.Extract.Documents.DocumentExtractedField", b =>
                {
                    b.HasOne("Dignite.Extract.Documents.Document", null)
                        .WithMany("ExtractedFieldValues")
                        .HasForeignKey("DocumentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Dignite.Extract.Documents.Fields.FieldDefinition", null)
                        .WithMany()
