...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Dignite.DocumentAI.Documents.Cabinets.Cabinet", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("DocAICabinets", (string)null);
                });

            modelBuilder.Entity("Dignite.DocumentAI.Documents.Document", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("OriginConstituentKey")
                        .HasMaxLength(64)
                    ...
                    b.HasIndex("ReviewDisposition");

                    b.HasIndex("OriginDocumentId", "OriginConstituentKey")
                        .IsUnique()
                        .HasFilter("[OriginDocumentId] IS NOT NULL");

                    b.HasIndex("TenantId", "DocumentTypeId");

                    b.ToTable("DocAIDocuments", (string)null);
                });

            modelBuilder.Entity("Dignite.DocumentAI.Documents.DocumentExtractedField", b =>
                {
                    ...
                    b.HasKey("DocumentId", "FieldDefinitionId", "Order");
                    ...
                    b.HasIndex("TenantId", "FieldDefinitionId", "NumberValue", "DocumentId");

                    b.HasIndex("TenantId", "FieldDefinitionId", "TextValue", "DocumentId");

                    b.ToTable("DocAIDocumentExtractedFields", (string)null);
                });

            modelBuilder.Entity("Dignite.DocumentAI.Documents.DocumentTypes.DocumentType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("DocAIDocumentTypes", (string)null);
                });

            modelBuilder.Entity("Dignite.DocumentAI.Documents.Exports.ExportTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("DocAIExportTemplates", (string)null);
                });

            modelBuilder.Entity("Dignite.DocumentAI.Documents.Fields.FieldDefinition", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("DocAIFieldDefinitions", (string)null);
                });

            modelBuilder.Entity("Dignite.DocumentAI.Documents.Figures.DocumentFigure", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("CropBlobName")
                        .IsRequired()
                        .HasMaxLength(512)
                        .HasColumnType("nvarchar(512)");
                    ...
                    b.Property<Guid?>("RoutedDocumentId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("SourceDocumentId", "ContentHash")
                        .IsUnique();

                    b.ToTable("DocAIDocumentFigures", (string)null);
                });

            modelBuilder.Entity("Dignite.DocumentAI.Documents.Pipelines.DocumentPipelineRun", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("DocAIDocumentPipelineRuns", (string)null);
                });

            modelBuilder.Entity("Dignite.DocumentAI.Documents.Segments.DocumentSegment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("DocAIDocumentSegments", (string)null);
                });
            ...
            modelBuilder.Entity("Dignite.DocumentAI.Documents.Document", b =>
                {
                    b.HasOne("Dignite.DocumentAI.Documents.Cabinets.Cabinet", null)
                        .WithMany()
                        .HasForeignKey("CabinetId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("Dignite.DocumentAI.Documents.DocumentTypes.DocumentType", null)
                        .WithMany()
                        .HasForeignKey("DocumentTypeId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.OwnsOne("Dignite.DocumentAI.Documents.FileOrigin", "FileOrigin", b1 =>
                        {
                            ...
                            b1.Property<string>("UploadedByUserName")
                                .IsRequired()
                                .HasMaxLength(256)
                                .HasColumnType("nvarchar(256)");
            ...
            modelBuilder.Entity("Dignite.DocumentAI.Documents.DocumentExtractedField", b =>
                {
                    b.HasOne("Dignite.DocumentAI.Documents.Document", null)
                        .WithMany("ExtractedFieldValues")
                        .HasForeignKey("DocumentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Dignite.DocumentAI.Documents.Fields.FieldDefinition", null)
                        .WithMany()
