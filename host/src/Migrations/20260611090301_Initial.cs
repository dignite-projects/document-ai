    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DocAICabinets", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "DocAIDocumentTypes",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DocAIDocumentTypes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DocAIDocuments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DocAIDocuments_DocAICabinets_CabinetId",
                        column: x => x.CabinetId,
                        principalTable: "DocAICabinets",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_DocAIDocuments_DocAIDocumentTypes_DocumentTypeId",
                        column: x => x.DocumentTypeId,
                        principalTable: "DocAIDocumentTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });

            migrationBuilder.CreateTable(
                name: "DocAIExportTemplates",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DocAIExportTemplates", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DocAIExportTemplates_DocAIDocumentTypes_DocumentTypeId",
                        column: x => x.DocumentTypeId,
                        principalTable: "DocAIDocumentTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DocAIFieldDefinitions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DocAIFieldDefinitions_DocAIDocumentTypes_DocumentTypeId",
                        column: x => x.DocumentTypeId,
                        principalTable: "DocAIDocumentTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                name: "DocAIDocumentPipelineRuns",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "DocAIDocumentExtractedFields",
                columns: table => new
                {
                    DocumentId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DocAIDocumentExtractedFields", x => new { x.DocumentId, x.FieldDefinitionId, x.Order });
                    table.ForeignKey(
                        name: "FK_DocAIDocumentExtractedFields_DocAIDocuments_DocumentId",
                        column: x => x.DocumentId,
                        principalTable: "DocAIDocuments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DocAIDocumentExtractedFields_DocAIFieldDefinitions_FieldDefinitionId",
                        column: x => x.FieldDefinitionId,
                        principalTable: "DocAIFieldDefinitions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DocAIDocumentExtractedFields_FieldDefinitionId",
                table: "DocAIDocumentExtractedFields",
                column: "FieldDefinitionId");

            migrationBuilder.CreateIndex(
                name: "IX_DocAIDocumentExtractedFields_TenantId_FieldDefinitionId_DateTimeValue_DocumentId",
                table: "DocAIDocumentExtractedFields",
                columns: new[] { "TenantId", "FieldDefinitionId", "DateTimeValue", "DocumentId" });

            migrationBuilder.CreateIndex(
                name: "IX_DocAIDocumentExtractedFields_TenantId_FieldDefinitionId_DateValue_DocumentId",
                table: "DocAIDocumentExtractedFields",
                columns: new[] { "TenantId", "FieldDefinitionId", "DateValue", "DocumentId" });

            migrationBuilder.CreateIndex(
                name: "IX_DocAIDocumentExtractedFields_TenantId_FieldDefinitionId_NumberValue_DocumentId",
                table: "DocAIDocumentExtractedFields",
                columns: new[] { "TenantId", "FieldDefinitionId", "NumberValue", "DocumentId" });

            migrationBuilder.CreateIndex(
                name: "IX_DocAIDocumentExtractedFields_TenantId_FieldDefinitionId_TextValue_DocumentId",
                table: "DocAIDocumentExtractedFields",
                columns: new[] { "TenantId", "FieldDefinitionId", "TextValue", "DocumentId" });

            migrationBuilder.CreateIndex(
                name: "IX_DocAIDocumentPipelineRuns_DocumentId_PipelineCode_AttemptNumber",
                table: "DocAIDocumentPipelineRuns",
                columns: new[] { "DocumentId", "PipelineCode", "AttemptNumber" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_DocAIDocuments_CabinetId",
                table: "DocAIDocuments",
                column: "CabinetId");

            migrationBuilder.CreateIndex(
                name: "IX_DocAIDocuments_CreationTime",
                table: "DocAIDocuments",
                column: "CreationTime");

            migrationBuilder.CreateIndex(
                name: "IX_DocAIDocuments_DocumentTypeId",
                table: "DocAIDocuments",
                column: "DocumentTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_DocAIDocuments_FileOrigin_BlobName",
                table: "DocAIDocuments",
                column: "FileOrigin_BlobName");

            migrationBuilder.CreateIndex(
                name: "IX_DocAIDocuments_FileOrigin_ContentHash",
                table: "DocAIDocuments",
                column: "FileOrigin_ContentHash");

            migrationBuilder.CreateIndex(
                name: "IX_DocAIDocuments_LifecycleStatus",
                table: "DocAIDocuments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DocAIExportTemplates_DocumentTypeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DocAIFieldDefinitions_DocumentTypeId",
                table: "DocAIFieldDefinitions",
                column: "DocumentTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_DocAIFieldDefinitions_TenantId_DocumentTypeId",
                table: "DocAIFieldDefinitions",
                columns: new[] { "TenantId", "DocumentTypeId" });
