...
export const DOCUMENT_AI_TABLES = {
  Cabinets: 'DocumentAI.Cabinets',
  Documents: 'DocumentAI.Documents',
  DocumentRecycleBin: 'DocumentAI.DocumentRecycleBin',
  DocumentReviewQueue: 'DocumentAI.DocumentReviewQueue',
  DocumentTypes: 'DocumentAI.DocumentTypes',
  ExportTemplates: 'DocumentAI.ExportTemplates',
  FieldDefinitions: 'DocumentAI.FieldDefinitions',
} as const;
